...
//			final List<Concept> allConcepts = conceptService.getAllConcepts();
    ...
    public @ResponseBody
    ArrayList<ProposedConceptPackageDto> getProposals() {
    ...
    public @ResponseBody
    ProposedConceptPackageDto getProposalById(@PathVariable final String proposalId) {
    ...
    public @ResponseBody
    ProposedConceptPackageDto addProposal(@RequestBody final ProposedConceptPackageDto newPackage) {
    ...
    public @ResponseBody
    ProposedConceptPackageDto updateProposal(@PathVariable final String proposalId,
